...
struct StatementBalanceTests {
    ...
    func marchClosingBalance() async throws {
        let url = URL(fileURLWithPath: "/Users/developer/Documents/GitHub/shiny-happiness/samples/03.pdf")
    ...
    func februaryClosingBalance() async throws {
        let url = URL(fileURLWithPath: "/Users/developer/Documents/GitHub/shiny-happiness/samples/02.pdf")
        guard FileManager.default.fileExists(atPath: url.path) else { return }
...
struct StatementBalancePersistenceTests {
    ...
    func netWorthFromStatements() async throws {
        ...
        let urls = [
            URL(fileURLWithPath: "/Users/developer/Documents/GitHub/shiny-happiness/samples/01.pdf"),
            URL(fileURLWithPath: "/Users/developer/Documents/GitHub/shiny-happiness/samples/02.pdf"),
            URL(fileURLWithPath: "/Users/developer/Documents/GitHub/shiny-happiness/samples/03.pdf"),
        ]
