...
struct OpenbankMultiAccountTests {
    ...
    func testNoAccountDuplicates() async throws {
        ...
        let pipeline = IngestPipeline(context: context)
        let url1 = URL(fileURLWithPath: "/Users/imalvaroglez/Documents/GitHub/shiny-happiness/samples/01.pdf")
        let url2 = URL(fileURLWithPath: "/Users/imalvaroglez/Documents/GitHub/shiny-happiness/samples/02.pdf")
