...
struct IngestPipelineTests {
    ...
    func ingestsOpenbankPDF() async throws {
        ...
        let url = URL(fileURLWithPath: "/Users/imalvaroglez/Documents/GitHub/shiny-happiness/samples/202508.pdf")
    ...
    func rejectsEncryptedPDF() async throws {
        ...
        let url = URL(fileURLWithPath: "/Users/imalvaroglez/Documents/GitHub/shiny-happiness/samples/202302.pdf")
        let reports = await pipeline.ingest(files: [url])
